# uranite.os.arch.aarch64.memory
...
Read a single unsigned byte at addr+offset and zero-extend it to I64. ldrb into a 32-bit w-register zero-extends into the full 64-bit x-register.
...
Read a 32-bit integer at addr+offset and zero-extend it to I64. A 32-bit ldr into a w-register clears the upper 32 bits of the x-register.
